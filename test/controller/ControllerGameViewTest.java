...
public class ControllerGameViewTest {
    ...
    public void testUpdateEmptyCementary(){
        ...
        ActionEvent move = new ActionEvent(buttonMove, ActionEvent.ACTION_PERFORMED,buttonMove.getActionCommand());
        controller.actions(move, ControllerGameView.RED_SQUARE);
        assertTrue(controller.getMatch().getPlayer(ColorChessboardEnum.WHITE).getCemetery().isEmpty());
        assertTrue(controller.getMatch().getPlayer(ColorChessboardEnum.BLACK).getCemetery().isEmpty());
    ...
    public void testUpdateCemeteryWithPiece(){
        ...
        Pawn pawn = new Pawn(new Position(1,1), ColorChessboardEnum.WHITE ,controller.getMatch().getChessboard(), 'p');
        Pawn pawn2 = new Pawn(new Position(2,2), ColorChessboardEnum.BLACK, controller.getMatch().getChessboard(), 'P');
        ...
        ActionEvent move = new ActionEvent(buttonMove, ActionEvent.ACTION_PERFORMED,buttonMove.getActionCommand());
        controller.actions(move, ControllerGameView.RED_SQUARE);
        assertFalse(controller.getMatch().getPlayer(ColorChessboardEnum.BLACK).getCemetery().isEmpty());
        assertEquals("♟", gameView.getjLabelCemeteryBlack().getText());
